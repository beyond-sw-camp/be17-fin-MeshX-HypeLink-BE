package MeshX.HypeLink.direct_store.item.clothes.bottom.model.entity;
...
public class DirectBottomClothes extends DirectItem {
    ...
    @Builder
    public DirectBottomClothes(BottomClothesCategory category, Integer waist, Integer length, Integer amount, String name, String content, String company, String itemCode, Integer stock, String gender, String season, String size) {
