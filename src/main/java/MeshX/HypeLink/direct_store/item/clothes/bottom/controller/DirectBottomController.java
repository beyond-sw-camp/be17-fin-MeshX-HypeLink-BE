package MeshX.HypeLink.direct_store.item.clothes.bottom.controller;


import MeshX.HypeLink.common.BaseResponse;
import MeshX.HypeLink.direct_store.item.clothes.bottom.model.dto.request.DirectBottomCreateReq;
import MeshX.HypeLink.direct_store.item.clothes.bottom.model.dto.request.DirectBottomUpdateReq;
import MeshX.HypeLink.direct_store.item.clothes.bottom.model.dto.response.DirectBottomInfoListRes;
import MeshX.HypeLink.direct_store.item.clothes.bottom.model.dto.response.DirectBottomInfoRes;
import MeshX.HypeLink.direct_store.item.clothes.bottom.service.DirectBottomService;
