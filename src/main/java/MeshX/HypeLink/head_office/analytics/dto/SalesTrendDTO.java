...
public class SalesTrendDTO {
    ...
    public SalesTrendDTO(String dateStr, Long totalRevenue, Long orderCount, Long avgOrderValue) {
    ...
    public SalesTrendDTO(LocalDate date, Long totalRevenue, Long orderCount, Long avgOrderValue) {
        this.date = date;
        this.totalRevenue = totalRevenue;
        this.orderCount = orderCount;
        this.avgOrderValue = avgOrderValue;
