...
public class HeadOrder extends BaseEntity {
    @Id
    ...
    @Builder
    private HeadOrder(String itemName, Integer unitPrice, Integer quantity, Integer totalPrice, String deliveryAddress, String deliveryRequest, String orderRequest) {
