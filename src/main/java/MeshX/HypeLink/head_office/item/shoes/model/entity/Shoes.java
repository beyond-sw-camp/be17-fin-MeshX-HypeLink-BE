...
public class Shoes extends Item {
    ...
    @Builder
    public Shoes(ShoesCategory category, Integer size, Boolean waterproof, Integer amount, String name, String content, String company, String itemCode, Integer stock){
