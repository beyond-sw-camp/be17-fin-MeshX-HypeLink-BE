...
public class TopClothes extends Item {
    ...
    @Builder
    public TopClothes(TopClothesCategory category, Boolean longSleeve, String neckline, Integer amount, String name, String content, String company, String itemCode, Integer stock, String gender, String season, String size) {
