...
public class OuterClothes extends Item {
    ...
    @Builder
    public OuterClothes(OuterClothesCategory category, Boolean hooded, Boolean waterproof, Integer amount, String name, String content, String company, String itemCode, Integer stock, String gender, String season, String size) {
