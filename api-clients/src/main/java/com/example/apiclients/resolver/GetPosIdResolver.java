...
import com.example.apiclients.annotation.GetPosId;
...
public class GetPosIdResolver implements HandlerMethodArgumentResolver {

    private final AuthApiClient authApiClient;

    @Override
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasParameterAnnotation(GetPosId.class);
    }
